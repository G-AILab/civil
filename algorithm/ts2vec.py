...
class TS2Vec:
    ...
    def fit_ts_cot(self, train_data, n_epochs=None, n_iters=None, verbose=False,logger=None):
    ...
    def encode(self, data, mask=None, encoding_window=None, causal=False, sliding_length=None, sliding_padding=0, batch_size=None):
        ...
        encoding_window='full_series' # if train_labels.ndim == 1 else None
        #encoding_window='full_series' if train_labels.ndim == 1 else None
    ...
    def encode_online(self,data):
        ...
        with torch.no_grad():
            ...
            out = self._eval_with_pooling(data, mask, encoding_window=encoding_window)
            out = out.squeeze(1)
